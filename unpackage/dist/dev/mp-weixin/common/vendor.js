...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var jweixin = __webpack_require__(/*! jweixin-module/out/index.js */ 17);var _default =
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  add_staff: function add_staff(params) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      var pointer1 = Bmob.Pointer('shops');
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
    ...
    return new Promise(function (resolve, reject) {
      ...
      if (params.objectId) {//修改操作
        ...
        _query.find().then(function (res) {
          console.log(res);
          if (res.length == 0) {
            var _query2 = Bmob.Query('customs');
  ...
  get_moneyList: function get_moneyList(id) {
    return new Promise(function (resolve, reject) {
      var query = Bmob.Query("debt_history");
    ...
    return new Promise(function (resolve, reject) {
      ...
      if (params.objectId) {//修改操作
        ...
        _query.find().then(function (res) {
          console.log(res);
          if (res.length == 0) {
            var _query2 = Bmob.Query('producers');
