...
Z([3,'beizhu_style'])
Z([3,'请输入备注'])
Z([3,'padding:0 30rpx;margin-top:40rpx;'])
Z([3,'confrim_delivery'])
Z([3,'confrim_button'])
...
var fID=_n('form')
_rz(z,fID,'bindsubmit',19,e,s,gg)
cs.push("./pages/common/good_confrim/good_enter/good_enter.wxml:view:1:704")
var cJD=_n('view')
_rz(z,cJD,'style',20,e,s,gg)
cs.push("./pages/common/good_confrim/good_enter/good_enter.wxml:textarea:1:735")
var hKD=_mz(z,'textarea',['bindinput',21,'class',1,'placeholder',2],[],e,s,gg)
cs.pop()
_(cJD,hKD)
cs.pop()
_(fID,cJD)
cs.push("./pages/common/good_confrim/good_enter/good_enter.wxml:view:1:839")
var oLD=_n('view')
_rz(z,oLD,'style',24,e,s,gg)
cs.push("./pages/common/good_confrim/good_enter/good_enter.wxml:button:1:887")
var cMD=_mz(z,'button',['bindtap',25,'class',1,'disabled',2,'formType',3],[],e,s,gg)
