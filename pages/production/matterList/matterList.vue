	...
	<view class="page">
			...
			<uni-nav-bar :fixed="false" color="#333333" background-color="#FFFFFF" right-text="添加" @click-left="shaixuan"
			 @click-right="goto_add" left-text="筛选">
				<view class="input-view">
					...
					<input confirm-type="search" class="input" type="text" placeholder="请输入物料名字/编号" @confirm="input_confirm" @blur="input_confirm"
					 :value="search_text" />
				</view>
			</uni-nav-bar>
		...
		<view v-if="showOptions" class="modal_background" @click="showOptions = false">
			<view class="showOptions">
				<navigator class="input_item1" hover-class="none" url="/pages/production/matterCategroy/matterCategroy?type=choose" style="border: 1rpx solid#F7F7F7;padding: 10rpx 30prx;">
