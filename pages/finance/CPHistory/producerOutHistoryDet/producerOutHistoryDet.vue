	...
	<view>
		<view class='page'>
			...
			<view class="backgroundfff" style="padding: 0 20rpx;margin-top: 20rpx;">
				...
				<view>
					<view class="display_flex" style="padding: 10rpx 0;border-bottom: 1rpx solid#F7F7F7;" v-if="orderDet.producer&&orderDet.producer.producer_name">
						...
						<view class="kaidan_rightinput display_flex" style="width: 100%;justify-content: flex-end;">
							<input placeholder="选择客户" disabled="true" :value="orderDet.producer.producer_name" style="text-align: right;margin-right: 20rpx;" />
						</view>
					</view>
			...
			<view class="backgroundfff" style="padding: 0 20rpx;margin-top: 20rpx;">
				<view class="newOrderTitle borderBot">已付款的单据</view>
				<view v-if="orderDet.producerOutOrders&&orderDet.producerOutOrders.length > 0">
					<view class="borderBot" style="padding: 20rpx 0;width: 100%;" v-for="(item,index) in orderDet.producerOutOrders" :key="index">
						...
						<view class="display_flex_bet">
							<view class="color333 display_flex">本次付款<text style="color: #f30;font-size: 20rpx;">*</text></view>
							<view class="display_flex">
								<input v-model="item.shouldGetMoney" placeholder="请输入本次付款" style="text-align: right;color: #f30;font-weight: bold;"
			...
			<view style="padding: 0 30rpx;margin-top: 60rpx;height: 90rpx;line-height: 90rpx;" class="bottomEle display_flex_bet">
				<view>
					<text>总计付款：￥{{orderDet.real_money || 0}}</text>
				</view>
				<view class="display_flex">
...
<script>
	...
	export default {
		...
		onLoad(options) {
			...
			query.include("opreater", "account", "producer", "producer", "secondClass", "fristClass");
