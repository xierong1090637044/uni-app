<template>
	<view class="page">
		...
		<view class="frist" v-for="(item,index) in model" :key="index" style="margin-bottom: 30rpx;">
			<view class="input_item">
				...
				<view class="right_input1 display_flex_bet" style="width: calc(100% - 200rpx);">
					<input placeholder="请输入颜色名" v-model="item.custom1.value" :disabled="type=='add'?false:true"></input>
			...
			<view class="input_item">
				...
				<view class="right_input1"><input placeholder="尺寸" v-model="item.custom2.value" :disabled="type=='add'?false:true"></input></view>
			</view>
			<view class="input_item">
				<view class="left_item"><input placeholder="自定义规格名1" v-model="item.custom3.name" /></view>
				<view class="right_input1"><input placeholder="请输入自定义规格1的值" v-model="item.custom3.value" :disabled="type=='add'?false:true"></input></view>
			</view>
			<view class="input_item">
				<view class="left_item"><input placeholder="自定义规格名2" v-model="item.custom4.name" /></view>
				<view class="right_input1"><input placeholder="请输入自定义规格2的值" v-model="item.custom4.value" :disabled="type=='add'?false:true"></input></view>
			</view>
		...
		<view class="input_item2 frist1" hover-class="none" url="/pages/manage/warehouse/warehouse?type=choose_more" style="margin: 30rpx 0;justify-content: center;"
		 @click="push_model" v-if="type=='add'">
