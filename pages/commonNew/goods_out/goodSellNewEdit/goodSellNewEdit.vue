				...
				<view style="margin: 30rpx 0 0;">
					...
					<view style="line-height: 70rpx;">
						...
						<view class="display_flex_bet orderListItemBorder borderBot">
							...
							<input placeholder='请输入备注' class='beizhu_style' name="input_beizhu" :value="beizhu_text"></input>
						</view>
					</view>
				</view>
...
<script>
	...
	export default {
		...
		onShow() {
			...
			if (uni.getStorageSync("discountMoney")) {
				that.discountMoney = Number(uni.getStorageSync("discountMoney").toFixed(2))
			...
			that.beizhu_text = uni.getStorageSync("beizhu_text") ||''
